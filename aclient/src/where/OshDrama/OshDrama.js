            ...
            <svg className='dont-select-text' width={530} height={356} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g>
                        ...
                        <g>
                            ...
                            <rect onClick={()=>{setSelectSector('сектор 1'); holderPart('сектор 1', event)}} className='pointer-text' stroke="#191e28" id="svg_2" height="211.999999" width="230.00002" y="55.4375" x="37.499986" strokeWidth={0} fill={selectSector==='сектор 1'?'red':'#191e28'} />
                        </g>
                        ...
                        <text fill="#ffffff" stroke="#ffffff" strokeWidth={0} x="145.5" y="175.4375" id="svg_43" fontSize={17} fontFamily="Helvetica, Arial, sans-serif" textAnchor="start" xmlSpace="preserve">A</text>
                        <g>
                            <title>
                                Свободно: {freeSeat['сектор 2']}
                            </title>
                            <rect onClick={()=>{setSelectSector('сектор 2'); holderPart('сектор 2', event)}} className='pointer-text' stroke="#191e28" id="svg_4" height="211.999999" width="230.00002" y="55.4375" x="269.499986" strokeWidth={0} fill={selectSector==='сектор 2'?'red':'#191e28'} />
                        </g>
                        <text fill="#ffffff" stroke="#ffffff" strokeWidth={0} x="378.5" y="175.4375" id="svg_5" fontSize={17} fontFamily="Helvetica, Arial, sans-serif" textAnchor="start" xmlSpace="preserve">B</text>
                    </g>
                </svg>
