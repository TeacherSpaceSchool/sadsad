...
$clientId = "170000005";		//Берется из файлика Merchant Id
...
$okUrl = "https://kassir.kg/payment/tested";	//ССЫЛКА для возврата   URL which client be redirected if authentication is successful
$failUrl = "https://kassir.kg/payment/tested";	//ССЫЛКА для возврата  URL which client be redirected if authentication is not successful
$rnd = microtime();				//A random number, such as date/time
$currencyVal = "417";			//Код валюты у нас сомы поэтому 417  Currency code, 949 for TL, ISO_4217 standard
$storekey = "KYRGYZ17";		//Берется из файлика Store key value, defined by bank.
$storetype = "3d_Pay_Hosting";	//Тип операции в нашем случае ставим 3d_pay_hosting   3D authentication model
$lang = "ru";					//Языковые настройки   Language parameter, "tr" for Turkish (default), "en" for English
$instalment = "";				//Рассрочка Instalment count, if there's no instalment should left blank
